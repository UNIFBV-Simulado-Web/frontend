...
const subjectsData: Subject[] = [
  {
    title: "Matemática",
    description: "10 questões de Matemática",
    bgColor: "bg-pink-600",
  ...
  },
  {
    title: "Linguagem",
    description:
      "10 Questões de Língua Portuguesa, Inglês/Espanhol, Literatura, Artes e Ed. Física",
    bgColor: "bg-cyan-500",
  ...
  },
  {
    ...
    description: "10 questões de Biologia, Física e Química",
  ...
  },
  {
    ...
    description: "10 questões de História, Geografia, Filosofia e Sociologia",
